 ...
 */
	...
	if($match !== false) {
      ...
      header("Location: https://foodivos.com/smoothiesandmore");
      die();
      //
      ...
      header("Location: http://foodivos.com/smoothiesandmore");
      die();
...
<html>
	<head>
		<title>Sorry, this coupon has expired.</title>
	</head>
	<body>
		<h1>Sorry, this coupon has expired.</h1>
	</body>
</html>
